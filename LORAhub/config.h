...
#define CUSTOM_NAME "Hub"	// This is only used if Auto_name is set to be 0
...
// --- Ethernet Options ---
	...
	IPAddress ip(209,193,17,253); 						  // device's IP address  				try to make this a string, so #include can be move to ethernet file
#endif
