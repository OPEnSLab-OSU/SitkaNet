...
// --- Tipping Bucket ---
#define is_tipBucket 1 // 1 to enable tipping bucket
#define tipBucket_pin 12 // Pin tipping bucket is attached to
...
// ================================================================
#if is_multiplexer == 1
	#define UPDATE_PERIOD -1		// Milliseconds between multiplexer sensor list being updated
