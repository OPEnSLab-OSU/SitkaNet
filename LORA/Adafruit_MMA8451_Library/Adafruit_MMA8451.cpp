...
/**************************************************************************/
/*!
    @brief  Public function to write 8-bits to the specified destination register
*/
/**************************************************************************/
void Adafruit_MMA8451::writeRegister8_public(uint8_t reg, uint8_t value)
{
...
*/
/**************************************************************************/
void Adafruit_MMA8451::setTransientIntThreshold(uint8_t range)
{
  range = range % 128;
  uint8_t reg1 = readRegister8(MMA8451_REG_CTRL_REG1);
  writeRegister8(MMA8451_REG_CTRL_REG1, 0x00); // deactivate
  uint8_t tths = readRegister8(MMA8451_REG_TRANSIENT_THS);
  tths &= ~(0b01111111); // mask off bits 6:0
  tths |= (range);
  writeRegister8(MMA8451_REG_TRANSIENT_THS, tths);
  writeRegister8(MMA8451_REG_CTRL_REG1, reg1); // deactivate
}
