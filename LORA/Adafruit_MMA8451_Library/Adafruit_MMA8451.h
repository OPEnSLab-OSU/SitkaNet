...
#define MMA8451_REG_HP_FILTER 0x0F
#define MMA8451_REG_PL_STATUS 0x10
#define MMA8451_REG_PL_CFG 0x11
#define MMA8451_REG_MTFF_CFG 0x15
#define MMA8451_REG_MTFF_THS 0x17
#define MMA8451_REG_MTFF_COUNT 0x18
...
public:
  ...
  void setTransientIntThreshold(uint8_t range);
  ...
  void writeRegister8_public(uint8_t reg, uint8_t value);
