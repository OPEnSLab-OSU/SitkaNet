...
void convert_OSC_bundle_to_string(OSCBundle *bndl, char *osc_string)
{
    LOOM_DEBUG_Println("In convert_OSC_bundle_to_string");
...
//  char larger_buf[384];
  ...
  original_convert_OSC_bundle_to_string(bndl, (char*)larger_buf);
   ...
   LOOM_DEBUG_Println(larger_buf);
   LOOM_DEBUG_Println2("long Message length: ", strlen(larger_buf));
...
void original_convert_OSC_bundle_to_string(OSCBundle *bndl, char *osc_string)
{
  LOOM_DEBUG_Println("In original_convert_OSC_bundle_to_string");
